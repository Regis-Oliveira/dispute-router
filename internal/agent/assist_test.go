...
func TestTheCeilingCountsEarlierAttempts(t *testing.T) {
	script := &ScriptedCompleter{Responses: []Response{
		draftResponse(t, draftInput{Recommendation: RecommendRepresent, Letter: "Reason code 10.4; the charge of 41.00 USD stands."}, Usage{InputTokens: 900, OutputTokens: 100}),
		verdictResponse(t, verdictInput{Pass: false, Findings: []Finding{{Check: CheckUnsupportedClaim, Quote: "stands", Why: "unsupported"}}}, Usage{InputTokens: 1000, OutputTokens: 40}),
	}}
...
func TestTheSecondAttemptIsToldWhyTheFirstWasRejected(t *testing.T) {
	script := &ScriptedCompleter{Responses: []Response{
		draftResponse(t, draftInput{Recommendation: RecommendRepresent, Letter: "The parcel was signed for. Reason code 10.4."}, Usage{InputTokens: 900, OutputTokens: 100}),
		verdictResponse(t, verdictInput{Pass: false, Findings: []Finding{{Check: CheckUnsupportedClaim, Quote: "signed for", Why: "no signature is on file"}}}, Usage{InputTokens: 1000, OutputTokens: 40}),
		draftResponse(t, draftInput{Recommendation: RecommendRepresent, Letter: "The charge of 41.00 USD was authorised. Reason code 10.4."}, Usage{InputTokens: 950, OutputTokens: 100}),
		verdictResponse(t, verdictInput{Pass: true}, Usage{InputTokens: 1000, OutputTokens: 20}),
	}}
